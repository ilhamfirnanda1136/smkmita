 ...
 ?>
   <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Upload Soal</h6>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    $dataupload=mysqli_query($con,"select * from upload_soal where id_guru='$idguru' ");
                    foreach ($dataupload as $upload ){ ?>
                    <tr>
                      <td><?=$upload['id_uploadsoal']?></td>
                      <td><?=$upload['judul_soal']?></td>
                      <td><?=tgl($upload['tgl_upload'])?></td>
                      <td> <a href="hapus.php?id=<?php echo $upload['id_uploadsoal'] ?>" class="btn-sm btn-danger btn" onclick="return confirm('yakin ingin menghapus file ini');">Hapus</a></td>
                       <td><a href="checkdownload.php?id=<?php echo $upload['id_uploadsoal']?>" class="btn-sm btn-primary btn">Check Download</a></td>
                    </tr>
                     <?php } ?>
 					</tbody>
                </table>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class="form-body">
                    <div class="form-group">
                      <div align="center">
                           <label class="control-label col-md-12">Pilih file link atau upload toogle recommended link</label>
                     <div class="col-md-12">
                       ...
                       <input type="text" class="form-control" name="link" id="link" placeholder="masukkan link redirect">
                            <input type="file" class="form-control-file form-control" name="upload" accept=".pdf,.docs,.xlsx,.exe" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" style="display: none;">
                ...
                <div class="form-group">        
                  <label class="control-label col-md-12">Gambar</label>
                    <div class="col-md-12">
                            ...
                            <input type="file" class="form-control-file form-control" name="gambar" accept=".png,.jpg,.jpeg" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
